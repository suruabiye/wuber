                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="info">
                                <div class="personal-info small-section">
                                    ...
                                    <div class="personal-details small-section-item">
                                        <div class="row">
                                            <div class="col-lg-6">
                            ...
                            <div role="tabpanel" class="tab-pane" id="vehicles">
                                <div class="vahicles-container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="single-vehicle-container">
                                                <img src="assets/images/21_our_vehicles.png" alt="Vehicle">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="single-vehicle-container">
                                                <img src="assets/images/22_our_vehicles.png" alt="Vehicle">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="single-vehicle-container">
                                                <img src="assets/images/23_our_vehicles.png" alt="Vehicle">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="single-vehicle-container">
                                ...
                                <div class="drivers-info">
                                    ...
                                    <div class="row small-section">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="single-driver">
                                                <div class="card">
                                                    <img class="card-img-top" src="assets/images/14_my_driver_dashboard_my_drivers.png" alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">John Smith</h4>
                                                        <p class="card-text">(+1) 123 456 7890</p>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="single-driver">
                                                <div class="card">
                                                    <img class="card-img-top" src="assets/images/15.png" alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">John Smith</h4>
                                                        <p class="card-text">(+1) 123 456 7890</p>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="single-driver">
                                                <div class="card">
                                                    <img class="card-img-top" src="assets/images/16.png" alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">John Smith</h4>
                                                        <p class="card-text">(+1) 123 456 7890</p>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="single-driver">
                                                <div class="card">
                                                    <img class="card-img-top" src="assets/images/19.png" alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">John Smith</h4>
                                                        <p class="card-text">(+1) 123 456 7890</p>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="single-driver">
                                                <div class="card">
                                                    <img class="card-img-top" src="assets/images/20.png" alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">John Smith</h4>
                                                        <p class="card-text">(+1) 123 456 7890</p>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="single-driver">
                                                <div class="card">
                                                    <img class="card-img-top" src="assets/images/21.png" alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">John Smith</h4>
                                                        <p class="card-text">(+1) 123 456 7890</p>
                                                    </div>
